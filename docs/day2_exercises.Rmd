...
4. **Publikationsreife Abbildungen** - Erstelle Plots bereit für eine Forschungsarbeit
...
cat("⚡ Rcpp Turbo-Modus aktiviert! Funktionen sind jetzt 10-50x schneller.\n")
</code></pre>
...
<span class="de">Hinweis: Fülle Farben "darkgreen" und "red" ein. Für Steigungsverhältnis nutze `calc_slope_ratio`.</span>
</div>
...
**Konzept:** Fassen wir alles zusammen und erstellen eine publikationsreife Abbildung die unser Hauptergebnis zeigt: wie heimische vs Alien-Arten unterschiedlich über österreichische Plots akkumulieren.
