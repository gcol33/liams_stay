...
ggplot(df_beta, aes(x = sites, y = value, colour = group)) +
  ...
  labs(
    ...
    subtitle = "Baselga (2010): bsor = bsim + bnes. Each row-column panel has its own y-axis.",
...
The beta diversity decomposition now separates **native** and **alien** species. Both groups show turnover-dominated patterns, but with important differences.
...
Die Beta-Diversitäts-Zerlegung trennt nun **heimische** und **gebietsfremde** Arten. Beide Gruppen zeigen Turnover-dominierte Muster, aber mit wichtigen Unterschieden.
